...
public class DragAndDropDataGrid<T> extends DataGrid<T> {
     ...
     *
     * @param pageSize    the page size
     * @param keyProvider an instance of ProvidesKey<T>, or null if the record object
     ...
     *                    should act as its own key
     */
    public DragAndDropDataGrid(int pageSize, Resources resources, ProvidesKey<T> keyProvider) {
     ...
     */
    public DragAndDropDataGrid(int pageSize, Resources resources, ProvidesKey<T> keyProvider, Widget loadingIndicator) {
