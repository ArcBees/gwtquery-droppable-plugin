...
public class Droppable extends UiPlugin {
    ...
    public Droppable destroy() {
        ...
        for (Element e : elements()) {
            ...
            $(e).removeClass(CssClassNames.GWTQUERY_DROPPABLE, CssClassNames.GWTQUERY_DROPPABLE_DISABLED).removeData
     ...
     *
     * @param droppableOptions options used to initialize the droppable
     * @return
     */
     ...
     * @return
     */
    public Droppable droppable(DroppableOptions droppableOptions, HasHandlers eventBus) {
