...
public class DragAndDropNodeInfo<T> extends DefaultNodeInfo<T> {
     ...
     *
     * @param cell                     the Cell used by this Node
     ...
     * Construct a new {@link DragAndDropNodeInfo}.
     *
     * @param dataProvider   the {@link AbstractDataProvider} that provides the child values
     * @param cell           the {@link Cell} used to render the child values update when the
     *                       selection changes
     * @param selectionModel the {@link SelectionModel} used for selection
     * @param valueUpdater   the {@link ValueUpdater}
     */
    public DragAndDropNodeInfo(AbstractDataProvider<T> dataProvider, Cell<T> cell, SelectionModel<? super T>
            selectionModel, ValueUpdater<T> valueUpdater) {
     ...
     */
    public DragAndDropNodeInfo(AbstractDataProvider<T> dataProvider, Cell<T> cell, SelectionModel<? super T>
            selectionModel, ValueUpdater<T> valueUpdater, CellDragAndDropBehaviour<T> cellDragAndDropBehaviour) {
