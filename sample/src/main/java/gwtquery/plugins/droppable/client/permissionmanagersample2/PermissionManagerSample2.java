 ...
 *
 * Just use a {@link gwtquery.plugins.droppable.client.gwt.DragAndDropCellTree} instead of a {@link com.google.gwt.user.cellview.client.CellTree} and
 * {@link gwtquery.plugins.droppable.client.gwt.DragAndDropNodeInfo} instead of {@link com.google.gwt.view.client.TreeViewModel.NodeInfo}
 *
...
public class PermissionManagerSample2 implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    RootPanel.get("permission").add(new Label("Hierarchy"));
    RootPanel.get("permission").add(createPermissionTree(membersList.getOriginalWidget()));
  ...
  private DroppableWidget<DragAndDropCellList<MemberInfo>> createAllMemberList() {
    ...
    DragAndDropCellList<MemberInfo> cellList = new DragAndDropCellList<MemberInfo>(
        new DetailledMemberCell(), MemberInfo.KEY_PROVIDER);
  ...
  /**
   * Create the permission tree. Use a {@link gwtquery.plugins.droppable.client.gwt.DragAndDropCellTree} instead of a
   * {@link com.google.gwt.user.cellview.client.CellTree}. The drag and drop behavior will be configured thanks to
   * the {@link gwtquery.plugins.droppable.client.gwt.DragAndDropNodeInfo} in {@link gwtquery.plugins.droppable.client.permissionmanagersample2.MemberTreeViewModel} class
   *
   * @return
   * @param originalWidget
   */
  private DragAndDropCellTree createPermissionTree(DragAndDropCellList<MemberInfo> memberList) {
